  ...
  return (
    <div className="min-h-screen bg-white dark:bg-dark-bg flex flex-col">
      ...
      <div className="sr-only">
        <h1>{subcategoryName} in New York City</h1>
        <p>Discover verified {subcategoryName.toLowerCase()} in New York City. Browse portfolios, read authentic reviews, and connect instantly with top-rated professionals.</p>
      </div>
