    ...
    <div className="min-h-screen bg-white dark:bg-dark-bg flex flex-col">
      ...
      <div className="w-full md:max-w-7xl md:mx-auto px-2 md:px-6 lg:px-8 pt-6">
        <div className="flex items-center gap-2 text-sm text-gray-600 dark:text-gray-400 mb-3">
            <Link href="/city/vancouver" className="hover:text-orange-600 dark:hover:text-orange-400 transition-colors">
              Vancouver
            </Link>
            ...
            <Link
              href={`/city/vancouver/${categorySlug}`}
      ...
      <div className="sr-only">
        <h1>{subcategoryName} in Vancouver</h1>
        <p>Discover verified {subcategoryName.toLowerCase()} in Vancouver. Browse portfolios, read authentic reviews, and connect instantly with top-rated professionals.</p>
      </div>
