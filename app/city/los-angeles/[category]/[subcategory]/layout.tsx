...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: {
      title,
      description,
      url: `${SITE_URL}/city/los-angeles/${categorySlug}/${subcategorySlug}`,
      siteName: 'BuzzGram',
      locale: 'en_US',
      type: 'website',
    },
    ...
    alternates: {
      canonical: `${SITE_URL}/city/los-angeles/${categorySlug}/${subcategorySlug}`,
    },
  };
}
...
export default async function SubcategoryLayout({ params, children }: Props) {
  ...
  const collectionPageSchema = {
    ...
    '@type': 'CollectionPage',
    '@id': `${SITE_URL}/city/los-angeles/${categorySlug}/${subcategorySlug}`,
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      },
      {
        ...
        item: `${SITE_URL}/city/los-angeles/${categorySlug}/${subcategorySlug}`,
      },
    ],
  };
